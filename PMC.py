...
model = load('PMC_model.joblib')
scalerX = load('PMC_scalerX.joblib')
scalerY = load('PMC_scalerY.joblib')
...
st.title('Predictive Analytics for Peritoneal and Mesenteric Cancers')

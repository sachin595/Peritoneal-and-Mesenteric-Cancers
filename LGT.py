...
model = load('LGT_model.joblib')
scalerX = load('LGT_scalerX.joblib')
scalerY = load('LGT_scalerY.joblib')
...
st.title('Predictive Analytics for Lower Gastrointestinal Tract ')
